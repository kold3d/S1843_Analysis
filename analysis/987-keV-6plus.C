{
    ...
    int firstRun= 9974, lastRun= 9974, goodpoints=0; // 6 Torr, 6+
    ...
    TCut bgo = "head.bgo.esort[0]>1.0 && head.bgo.esort[0]<10.0";
    TCut SepTOF = "!(tail.io32.trigger_latch & 128) && !(coinc.xtofh==-1)";
    TCut recoils = SepTOF && "coinc.xtofh>1650 && coinc.xtofh<1900";
    TCut dsssd = "tail.dsssd.efront>100 && tail.dsssd.efront<1000";
