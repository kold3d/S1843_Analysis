{
    ...
    int firstRun= 9991, lastRun= 9992, goodpoints=0; // 6 Torr, 6+
    ...
    TCut recoils = SepTOF && "coinc.xtofh>1650 && coinc.xtofh<1850";
    TCut dsssd = "tail.dsssd.efront>150 && tail.dsssd.efront<800";
