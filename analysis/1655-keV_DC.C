{
    ...
    int firstRun= 9941, lastRun= 9946, goodpoints=0; // 4.6 Torr
    ...
    TCut recoils = SepTOF && "coinc.xtofh>1300 && coinc.xtofh<1600";
    TCut dsssd = "tail.dsssd.efront>1400 && tail.dsssd.efront<1800";
    ...
    */
    ...
    singles->SetStats(0);
    singles->GetXaxis()->SetRangeUser(0,2400);
    ...
    t5-> Draw("coinc.tail.ic.anode[1]:coinc.tail.ic.anode[0]", "coinc.tail.ic.anode[1]>0 && coinc.tail.ic.anode[0]>0", "COLZ");
