{
    ...
    int firstRun= 9964, lastRun= 9964, goodpoints=0; // 6 Torr, 6+
    ...
    TCut recoils = SepTOF && "coinc.xtofh>1650 && coinc.xtofh<1950";
    TCut dsssd = "tail.dsssd.efront>100 && tail.dsssd.efront<600";
