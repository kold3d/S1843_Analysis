...
outfile << "Run Nsb0_tot Nsb0_tot_err Nsb0_start Nsb0_start_err Nsb0_end Nsb0_end_err Nsb1_tot Nsb1_tot_err Nsb1_start Nsb1_start_err Nsb1_end Nsb1_end_err" <<
endl;
}
...
sprintf(fname,
"/data/astro/dragon/S1843/data/rootfiles/run%i.root", runs.
at(i)
);
...
outfile << runs.
at(i)
<< " " << Nsb0 << " " << Nsb0_err << " " << Nsb0_t0 << " " << Nsb0_t0_err << " " << Nsb0_t1 << " " << Nsb0_t1_err << " " << Nsb1 << " " << Nsb1_err << " " << Nsb1_t0 << " " << Nsb1_t0_err << " " << Nsb1_t1 << " " << Nsb1_t1_err <<
endl;
}
}
